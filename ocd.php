...
<body>
    ...
    <div class="card-container">
        <div class="card">
            <img src="./img/shape.png" alt="Autism Image">
            <h2><br>Match Me</h2>
            <p class="simon-text">This Shape Matching Game helps in identifying potential signs of OCD by analyzing user interactions, such
                as repeated attempts and errors. The feedback provided at the end of the game can highlight tendencies towards perfectionism or
                frustration, suggesting if professional advice may be beneficial.</p>
            <a href="./games/ocd games/index.html" target="_blank" class="play-game">Play Game</a>
        </div>

        <div class="card">
            <img src="./img/click.png" alt="Autism Image">
            <h2><br>Precision Clicking Game</h2>
            <p class="mem-text">The precision clicking game can be a valuable tool for managing OCD by providing a structured environment that
                enhances focus and control. Engaging in this game helps users practice attention to detail and precision, which reinforces their
                ability to concentrate on specific tasks. </p>
            <a href="./games/ocd games/index2.html" target="_blank" class="play-game">Play Game</a>
        </div>
    </div>
