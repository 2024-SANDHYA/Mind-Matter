...
<body>
    ...
    <div class="card-container">
        <div class="card">
            <img src="./img/simon-says-game.jpg" alt="ADHD Image">
            <h2><br>Simon Says</h2>
            <p class="simon-text">Help analyze ADHD by assessing attention, working memory, and impulse control. The game requires players to focus
                on and remember sequences, which can be challenging for those with ADHD. Difficulties in maintaining attention and remembering sequences
                can indicate issues with working memory.</p>
            <a href="./games/adhd games/simonsays.html" target="_blank" class="play-game">Play Game</a>
        </div>
        <div class="card">
            <img src="./img/mem-banner.png" alt="ADHDImage">
            <h2><br>Memory Match</h2>
            <p class="mem-text">This game is designed to evaluate key cognitive functions often impacted by ADHD, such as focus, working memory, and impulse
                control. Players are challenged to concentrate and recall the positions of various images, a task that can be particularly demanding
                for those with ADHD.</p>
            <a href="./games/adhd games/memory.html" target="_blank" class="play-game">Play Game</a>
        </div>
    </div>
