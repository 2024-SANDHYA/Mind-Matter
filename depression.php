...
<head>
    ...
    <title>Depression Analyses</title>
</head>
...
<body>
    ...
    <div class="card-container">
        <div class="card">
            <img src="./img/cbt.png" alt="Autism Image">
            <h2><br>CBT Game</h2>
            <p class="simon-text">CBT games help in depression analysis by encouraging self-reflection through interactive scenarios,
                identifying negative thought patterns, and providing immediate feedback. They track changes in cognitive and emotional
                responses over time, helping users recognize and challenge unhealthy thoughts.</p>
            <a href="./games/depression game/index.html" target="_blank" class="play-game">Play Game</a>
        </div>

        <div class="card">
            <img src="./img/mood.png" alt="Autism Image">
            <h2><br>Daily Mood Chart</h2>
            <p class="mem-text">The Daily Mood Chart game aids in managing depression by promoting self-awareness and emotional tracking.
                It encourages users to regularly monitor their moods, helping them identify patterns and triggers over time.By visualizing
                their emotional states, users can better understand their mental health and take steps.</p>
            <a href="./games/depression game/moodchart.html" target="_blank" class="play-game">Play Game</a>
        </div>
    </div>
